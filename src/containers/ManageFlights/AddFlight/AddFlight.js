...
class AddFlight extends Component {
  ...
  postFlightToDatabase = () => {
    ...
    axios
      .post(`${this.state.uri}/flight/`, flight)
      .then(
        this.setState({
          startingDestination: "",
          finalDestination: "",
            ...
            >
              <Form.Group controlId="setStartingDestination">
                ...
                <Form.Control
                  ...
                  value={this.state.startingDestination}
                  onChange={(event) =>
                    this.setState({ startingDestination: event.target.value })
                  }
                />
              ...
              <Form.Group controlId="setFinalDestination">
                ...
                <Form.Control
                  ...
                  onChange={(event) =>
                    this.setState({ finalDestination: event.target.value })
                  }
                />
                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
              ...
              <Form.Group controlId="setRocketCapacity">
                ...
                <Form.Control
                  ...
                  min="10"
                  max="20"
                  value={this.state.rocketCapacity}
                  onChange={(event) =>
                    this.setState({ rocketCapacity: event.target.value })
                  }
                />
                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
                  Type inrocket capacity
                </Form.Control.Feedback>
              </Form.Group>
