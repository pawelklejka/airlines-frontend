...
class EditFlight extends Component {
  ...
  getFlightFromDatabase = () => {
    axios
      .get(`${this.state.uri}/flight/` + this.props.match.params.id)
      .then((response) => {
        ...
        this.setState({
          flight: {
            ...
            finalDestination: flight[1][1],
            startingTime: flight[2][1],
            arrivalTime: flight[3][1],
            rocketCapacity: flight[4][1],
            price: flight[6][1],
            id: flight[7][1],
          },
  ...
  updateFlightToDatabase = () => {
    const flight = {
      ...
      finalDestination: this.state.flight.finalDestination,
    ...
    axios
      .put(
        `${this.state.uri}/flight/` + this.props.match.params.id,
        flight
      )
      .then(
        this.setState({
          ...
          <Card.Body>
            ...
            >
              <Form.Group controlId="setStartingDestination">
                <Form.Label>
                  Set the starting destination - city name
                </Form.Label>
                <Form.Control
                  required
                  type="text"
                  placeholder="Type in city name"
                  value={this.state.flight.startingDestination}
                  onChange={(event) =>
                    this.setState({
                      flight: {
                        ...this.state.flight,
                        startingDestination: event.target.value,
                      },
                    })
                  }
                />
              ...
              <Form.Group controlId="setFinalDestination">
                <Form.Label>Set the final destination - city name</Form.Label>
                <Form.Control
                  required
                  type="text"
                  placeholder="Type in city name"
                  value={this.state.flight.finalDestination}
                  onChange={(event) =>
                    this.setState({
                      flight: {
                        ...this.state.flight,
              ...
              <Form.Group controlId="setStartingTime">
                ...
                <Form.Control
                  ...
                  type="datetime-local"
                  value={this.state.flight.startingTime}
                  onChange={(event) =>
                    this.setState({
                      flight: {
                        ...this.state.flight,
              ...
              <Form.Group controlId="setArrivalTime">
                ...
                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
                  Type in arrival date
                </Form.Control.Feedback>
              </Form.Group>

              <Form.Group controlId="setRocketCapacity">
                <Form.Label>
                  Set the rocket capacity (number between 10 and 20)
                </Form.Label>
                <Form.Control
                  required
                  min="10"
                  max="20"
                  type="number"
                  placeholder="Type in the rocket capacity"
                  min="10"
                  max="20"
                  value={this.state.flight.rocketCapacity}
                  onChange={(event) =>
                    this.setState({
                      flight: {
                        ...this.state.flight,
                        rocketCapacity: event.target.value,
                      },
                    })
                  }
                />
